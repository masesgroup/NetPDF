...
namespace Org.Apache.Pdfbox.Cos
{
    ...
    public partial class COSName
    {
        ...
        /// </summary>
        public static Org.Apache.Pdfbox.Cos.COSName MCR { get { if (!_MCRReady) { _MCRContent = SGetField<Org.Apache.Pdfbox.Cos.COSName>(LocalBridgeClazz, "MCR"); _MCRReady = true; } return _MCRContent; } }
        private static Org.Apache.Pdfbox.Cos.COSName _MCRContent = default;
        private static bool _MCRReady = false; // this is used because in case of generics 
        /// <summary>
